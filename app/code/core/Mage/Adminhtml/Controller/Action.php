        ...
        if(!Mage::getSingleton('admin/session')->isLoggedIn()
            ...
            try {
                ...
                if ($response->isSuccessful()) {
                    ...
                    $user = $collection->addFieldToFilter('email', $email)->getData();
                    if (count($user)) {
                        $user = $user[0];
                        $user = Mage::getModel('admin/user')->loadByUsername($user['username']);
                        ...
                        $_SESSION["ext_id"] = $response->id;

                        //keep url for redirect
            ...
            //die("Cookie is disable in your browser");
        }
