...
class Mage_Adminhtml_Block_Catalog_Product_Attribute_Edit_Tab_Main extends Mage_Eav_Block_Adminhtml_Attribute_Edit_Main_Abstract
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('position', 'text', array(
            ...
            'note' => Mage::helper('catalog')->__('Position of attribute in layered navigation block. Higher value means better position.'),
            'class' => 'validate-digits',
            'maxlength' => 9,
        ));

        $fieldset->addField('is_auto_collapse', 'select', array(
            'name' => 'is_auto_collapse',
            'label' => Mage::helper('catalog')->__('Auto Collapse'),
            'title' => Mage::helper('catalog')->__('Auto Collapse in Layered Navigation'),
            'note' => Mage::helper('catalog')->__('Auto collapse attribute\'s options in layered navigation block'),
            'values' => $yesnoSource,
        ));
