...
//        $result .= "<br/> <strong>Mã Sản phẩm:</strong>" . $item->getSku();
        $result .= "<br/> <strong>Mã kho:</strong>" . $item->getProduct()->getWarehouseSku();
        $result .= "<br/> <strong>Mã kho Teko:</strong>" . $item->getProduct()->getBackupWhSku();
        return $result;
    }
