 ...
 */
class Ved_Gorders_Block_Adminhtml_Sales_Order_View_History extends Mage_Adminhtml_Block_Sales_Order_View_History
{
    ...
    public function canAddComment()
    {
        ...
        return $this->getOrder() && Mage::getSingleton('admin/session')->isAllowed('sales/order/actions/comment') &&
               $this->getOrder()->canComment();
    }

    public function getSubmitUrl()
    {
        return $this->getUrl('*/sales_order/addComment', array('order_id'=>$this->getOrder() ? $this->getOrder()->getId(): 0));
    }
