...
class Ved_Gorders_Block_Adminhtml_Sales_CompletedOrder_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->join(array('oi' => 'sales/order'), 'oi.entity_id=main_table.entity_id AND (oi.state="complete")'
