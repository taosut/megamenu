 ...
 */
class Ved_Gorders_Block_Adminhtml_Sales_Order extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function __construct()
    {
        ...
        if (!Mage::getSingleton('admin/session')->isAllowed('sales/order/actions/create')) {
            ...
            'label'   => Mage::helper('sales')->__('Export Non Cancel Order'),
            'onclick' => "setLocation('{$this->getUrl('*/Order/exportNonCancelOrders')}')",
            'class'   => 'add'
        ));
    }
