...
class Ved_Porders_Block_Adminhtml_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('ved_porders_grid');
    ...
    protected function _prepareCollection()
    {
        ...
        $collection
                ->join(array('oi'=>'sales/order'), 'oi.entity_id=main_table.entity_id AND (oi.status="processing" OR (oi.status="complete" AND oi.shipping_id not in (4,5,6)))'
    ...
    {
        $helper = Mage::helper('ved_porders');
