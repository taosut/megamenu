 ...
 */
class Ved_SalesRule_Model_Rule extends SalesRule_Model_Rule
{
    /**
    ...
    protected function _afterSave()
    {
        ...
        try{
            ...
            $mail->Subject = "Cảnh báo thay đổi coupon";
            //var_dump($this);die();
            ...
            $mail->addAddress('tuyetnhung.nguyen@ved.com.vn');
    ...
    private function emailBody(){
        $content = 'Hệ thống gửi cảnh báo: <br/><br/>';
        $content .= 'Voucher/campaign: ' . $this->getName() . ' đã được thêm vào hoặc bị thay đổi. <br/>';
        $content .= 'Nội dung mô tả của voucher/campaign: ' . $this->getDescription() .  ' <br/>';
        $content .= 'Người cập nhật: ' . Mage::getSingleton('admin/session')->getUser()->getUsername() .  ' <br/>';
        //$content .= 'Ngày cập nhật: ' . Mage::getSingleton('admin/session')->getUser()->getUsername();
        return $content;
    }
