...
class Ved_SupplierNew_Block_Adminhtml_Suppliernew_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
...
//  }
    ...
    protected function _prepareForm()
    {
        ...
        //var_dump($data);
        $fieldset = $form->addFieldset("supplier_form", array("legend" => Mage::helper("suppliernew")->__("Supplier information")));

        $fieldset->addField("supplier_code", "text", array(
            "label" => Mage::helper("suppliernew")->__("Supplier Code"),
        ...
        $fieldset->addField("supplier_name", "text", array(
            "label" => Mage::helper("suppliernew")->__("Supplier Name"),
            "class" => "required-entry",
            "required" => true,
            "name" => "supplier_name",
        ...
        $fieldset->addField("supplier_mobile", "text", array(
            "label" => Mage::helper("suppliernew")->__("Mobile"),
            "name" => "supplier_mobile",
            "required" => true,
        ));

        $fieldset->addField("supplier_contact", "text", array(
            "label" => Mage::helper("suppliernew")->__("Contact Name"),
        ...
        $fieldset->addField('supplier_province', 'select', array(
            ...
            "label" => Mage::helper("suppliernew")->__("Province"),
            "label" => Mage::helper("suppliernew")->__("Province"),
        ...
        if (($data && isset($data['supplier_province']) && isset($arrIdRegions[$data['supplier_province']])) || ($arrRegions && isset($arrRegions[0]) && isset($arrIdRegions[$arrRegions[0]]))) {
            ...
            $fieldset->addField('supplier_district', 'select', array(
                ...
                "label" => Mage::helper("suppliernew")->__("District"),
                "label" => Mage::helper("suppliernew")->__("District"),
        ...
        $fieldset->addField("supplier_address", "textarea", array(
            "label" => Mage::helper("suppliernew")->__("Address"),
            "name" => "supplier_address",
            "required" => true,
        ));

        $fieldset->addField("note", "textarea", array(
            "label" => Mage::helper("suppliernew")->__("Note"),
            "name" => "note",
        ));
