...
class Ved_SupplierNew_Block_Adminhtml_Suppliernew_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
    $collection = Mage::getModel("suppliernew/supplier")->getCollection();
  ...
  protected function _prepareColumns()
  {
    $this->addColumn("supplier_id", array(
      "header" => Mage::helper("suppliernew")->__("ID"),
      "align" => "right",
      "width" => "50px",
      "type" => "number",
      "index" => "supplier_id",
    ...
    $this->addColumn("supplier_code", array(
      "header" => Mage::helper("suppliernew")->__("Supplier Code"),
      "index" => "supplier_code",
    ));
    $this->addColumn("supplier_name", array(
      "header" => Mage::helper("suppliernew")->__("Supplier Name"),
      "index" => "supplier_name",
    ));
    $this->addColumn("supplier_mobile", array(
      "header" => Mage::helper("suppliernew")->__("Mobile"),
      "index" => "supplier_mobile",
    ));
    $this->addColumn("supplier_contact", array(
      "header" => Mage::helper("suppliernew")->__("Contact Name"),
      "index" => "supplier_contact",
    ));
    $this->addColumn("supplier_province", array(
      "header" => Mage::helper("suppliernew")->__("Province"),
    ...
    $this->addColumn("supplier_district", array(
      "header" => Mage::helper("suppliernew")->__("District"),
      "index" => "supplier_district",
    ));
    $this->addColumn('created_at', array(
      'header' => Mage::helper('suppliernew')->__('Created On'),
      'index' => 'created_at',
      'type' => 'datetime',
      'width' => '100px',
    ));
    $this->addColumn('updated_at', array(
      'header' => Mage::helper('suppliernew')->__('Updated On'),
      'index' => 'updated_at',
      'type' => 'datetime',
      'width' => '100px',
    ));
