...
class Ved_SupplierNew_Block_Adminhtml_Suppliernew_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
...
//    $this->setTitle(Mage::helper("supplier")->__("Supplier Information"));
        ...
        $this->_updateButton("save", "label", Mage::helper("suppliernew")->__("Save"));
        $this->_updateButton("delete", "label", Mage::helper("suppliernew")->__("Delete"));
        $this->removeButton("delete");

        $this->_addButton("saveandcontinue", array(
            "label" => Mage::helper("suppliernew")->__("Save And Continue Edit"),
    ...
    public function getHeaderText()
    {
        if (Mage::registry("supplier_data") && Mage::registry("supplier_data")->getId()) {
            return Mage::helper("suppliernew")->__("Edit Supplier '%s'", $this->htmlEscape(Mage::registry("supplier_data")->getSupplierName()));
        } else {
            return Mage::helper("suppliernew")->__("Add Supplier");
        }
    }
}