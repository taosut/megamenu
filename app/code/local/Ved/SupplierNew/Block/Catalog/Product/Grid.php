<?php
class Ved_SupplierNew_Block_Catalog_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
//        $attribute_items = Mage::getModel('eav/entity_attribute_option')->getCollection()->setStoreFilter()->join('attribute','attribute.attribute_id=main_table.attribute_id', 'attribute_code');
//        foreach ($attribute_items as $attribute_item) {
//            if ($attribute_item->getAttributeCode() == 'supplier'){
//                $supplier_options[$attribute_item->getOptionId()] = $attribute_item->getValue();
//            }
//            if ($attribute_item->getAttributeCode() == 'location'){
//                $location_options[$attribute_item->getOptionId()] = $attribute_item->getValue();
//            }
//        }
...
//                //'filter_condition_callback'=> array($this, '_filterSupplierCondition'),
//            ));
...
//                'filter_condition_callback' => array($this, '_filterLocationCondition'),
//                'renderer'=>new Mage_Adminhtml_Block_Catalog_Product_Renderer_Location()
//            ));
        $this->addColumn("image", array(
            "header" => Mage::helper("catalog")->__("Image"),
            "index" => "thumbnail",
            "renderer" =>"Ved_SupplierNew_Block_Catalog_Renderer_Image",
            'filter' => false
        ));
