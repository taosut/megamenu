...
class Ved_SupplierNew_Adminhtml_SupplierController extends Mage_Adminhtml_Controller_Action
{
    //List Supplier
    ...
    public function editAction()
    {
        ...
        if ($model->getId()) {
            ...
            $this->_addContent($this->getLayout()->createBlock("suppliernew/adminhtml_suppliernew_edit"));//->_addLeft($this->getLayout()->createBlock("supplier/adminhtml_supplier_edit_tabs"));
            $this->renderLayout();
        } else {
        ...
        if ($post_data) {
            ...
            try {
                ...
                if (is_null($supplierId) && isset($post_data['supplier_name'])) {
                    ...
                    $modelSupplier = Mage::getModel("suppliernew/supplier");
                ...
                $model = Mage::getModel("suppliernew/supplier");
...
//  }
    ...
    public function testAction()
    {
        ...
        foreach ($collection as $supplier) {
            echo '<h3>' . $supplier->getSupplier_name() . '</h3>';
        }
    }
}
