...
class Ved_SupplierNew_Adminhtml_Supplier_ProcumentController extends Mage_Adminhtml_Controller_Action
{
    //List Supplier
    ...
    //Manage Changed Price
    public function priceAction()
    {
        $this->_title($this->__("Manage Price"));
        $this->loadLayout()
            ->_setActiveMenu("adminhtml/suppliernew")
            ->_addBreadcrumb(
                Mage::helper("adminhtml")->__("Manage Price"),
                Mage::helper("adminhtml")->__("Manage Price")
            );
        $this->renderLayout();
    }
    ...
    //Manage procument
    public function procumentAction()
    {
        $this->_title($this->__("Manage Procument"));
        $this->loadLayout()
            ->_setActiveMenu("adminhtml/suppliernew")
            ->_addBreadcrumb(
                Mage::helper("adminhtml")->__("Manage Procument"),
                Mage::helper("adminhtml")->__("Manage Procument")
            );
        $this->renderLayout();
    }
    ...
    {
        $this->_title($this->__("Manage Payment"));
        $this->loadLayout()
            ->_setActiveMenu("adminhtml/suppliernew")
            ->_addBreadcrumb(
                Mage::helper("adminhtml")->__("Manage Payment"),
                Mage::helper("adminhtml")->__("Manage Payment")
            );
        $this->renderLayout();
    }
...
//  }
    ...
    {
//        $includePath = Mage::getBaseDir('lib') . '/Excel/PHPExcel.php';
...
//        $writer->save('php://output');
        ...
        if(isset($user)){
            ...
            $change->product_id = "12312313";
            $change->old_price = "1000";
            $change->new_price = "2000";
