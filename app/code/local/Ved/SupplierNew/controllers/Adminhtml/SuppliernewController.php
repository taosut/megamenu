...
class Ved_SupplierNew_Adminhtml_SupplierNewController extends Mage_Adminhtml_Controller_Action
{
    //List Supplier
    ...
    {
        $this->_title($this->__("Supplier"));
        $this->_title($this->__("Manager Product"));
    ...
    {
        $this->_title($this->__("Supplier"));
        $this->_title($this->__("Managing Price"));
    ...
    {
        $this->_title($this->__("Supplier"));
        $this->_title($this->__("Managing Procument"));
    ...
    {
        $this->_title($this->__("Supplier"));
        $this->_title($this->__("Managing Inventory"));
