...
class Ved_Norders_Block_Adminhtml_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('ved_norders_grid');
    ...
    protected function _prepareCollection()
    {
        ...
        $collection
                ->join(array('oi'=>'sales/order'), 'oi.entity_id=main_table.entity_id AND (oi.status="pending")', array('qty_ordered' => 'oi.total_qty_ordered' ), null,'inner')
    ...
    {
        $helper = Mage::helper('ved_norders');
...
//        ));
        ...
        $this->addColumn('pl_status', array(
