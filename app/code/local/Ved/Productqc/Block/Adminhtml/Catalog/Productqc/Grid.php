 ...
 */
class Ved_Productqc_Block_Adminhtml_Catalog_Productqc_Grid extends Mage_Adminhtml_Block_Widget_Grid
{

    public function __construct()
    {
        parent::__construct();
        $this->setId('ved_productqc_grid');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('product_images', array(
            'header'       => Mage::helper('catalog')->__('Images'),
            'index'        => 'entity_id',
            'type'  => 'text',
            'renderer'  => 'Ved_Productqc_Block_Adminhtml_Catalog_Renderer_ProductImage',
            'filter' => false
        ...
        $this->addColumn('product_description', array(
            ...
            'index'        => 'entity_id',
            'type'  => 'text',
            'renderer'  => 'Ved_Productqc_Block_Adminhtml_Catalog_Renderer_ProductDescription',
            'filter' => false
            // 'filter_index' => '(SELECT GROUP_CONCAT(\' \', x.name) FROM sales_flat_order_item x WHERE main_table.entity_id = x.order_id AND x.product_type != \'configurable\')'
        ));
    ...
    {
        $link= Mage::helper('adminhtml')->getUrl('adminhtml/catalog_product/edit/') .'id/' .$row->getId() ;
        return $link;
