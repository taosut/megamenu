 ...
 */
class Ved_Productqc_Block_Adminhtml_Catalog_Product_Edit extends Mage_Adminhtml_Block_Widget
{
    ...
    public function getDeleteButtonHtml()
    {
        ...
        if (Mage::getSingleton('admin/session')->isAllowed('admin/catalog/delete_product')) {
