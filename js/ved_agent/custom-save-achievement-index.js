...
function updateAchievement(requireComment, status, url) {
    var comment = ''
    ...
    if (requireComment) {
        if (comment !== null && !comment) {
            ...
            updateAchievement(requireComment, status, url)
            return false
    ...
    if (confirm('Admin có xác nhận ' + statusName[status - 1] + ' thành tích này?')) {
